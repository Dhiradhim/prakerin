    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
			...
			$id_user=$row_user['id'];
			$id=$_SESSION['id'];
			$query = mysqli_query($con, "SELECT siswa.*, user.username, perusahaan.id AS idper, perusahaan.nama_perusahaan FROM siswa INNER JOIN user ON siswa.id_user=user.id INNER JOIN perusahaan ON siswa.id_perusahaan=perusahaan.id WHERE siswa.id_user='$id_user'") or die(mysqli_connect_error());
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">								
									<form method="post" action="pendaftaran-siswa_edit_save.php">
